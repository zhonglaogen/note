...
public class SocketOptionTest {
    public static void main(String[] args) throws IOException {
        ...
        socket.setReuseAddress(true);//如reuse包例子,复用缓冲区
        ...
        socket.setKeepAlive(true);//如果将这个Socket选项打开，客户端Socket每隔段的时间（大约两个小时）
        // 就会利用空闲的连接向服务器发送一个数据包。这个数据包并没有其它的作用，
        // 只是为了检测一下服务器是否仍处于活动状态。如果服务器未响应这个数据包，在大约11分钟后，
        ...
        socket.setOOBInline(true);//如oobinline包例子，紧急指针，一个字节，立即发出
/*
