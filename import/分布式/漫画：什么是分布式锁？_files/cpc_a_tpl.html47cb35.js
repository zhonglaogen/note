...
if(n<t+Q.getInnerHeight()+100&&$.off(window,"scroll",p),!(lt||-1==dt||dt>0&&n-t-Q.getInnerHeight()>500)){
...
var o=+new Date;
lt=!0,i(ft.tips),m(ft.loading);
var c="/mp/appmsg_comment?action=getcomment&scene="+tt.scene+"&__biz="+biz+"&appmsgid="+appmsgid+"&idx="+idx+"&comment_id="+Z+"&offset="+dt+"&limit="+at+(window.send_time?"&send_time="+send_time:"");
try{
bt++,e&&(ht=[]),bt>1&&!e&&l(tt.moreList,encodeURIComponent(c)),ht.indexOf(c)>-1&&l(tt.repeatList,encodeURIComponent(c)),
ht.push(c);
}catch(s){}
...
var d=i.base_resp&&i.base_resp.ret;
if(0==d){
u(i,e);
var r=+new Date-n;
a(m,r);
}else l(tt.errList,"type:resperr;url:"+encodeURIComponent(c)+";ret="+d);
et("[Appmsg comment] get comment success"),_(),X||"5"!==window.item_show_type||(W.setAvg(112287,36,Date.now()-window.logs.pagetime.page_begin),
W.send(),X=!0);
},
error:function(){
l(tt.errList,"type:ajaxerr;url:"+encodeURIComponent(c)),et("[Appmsg comment] get comment ajax error");
},
complete:function(){
lt=!1,i(ft.loading),$.off(window,"scroll",M);
}
});
}
}
function u(e,t){
var n,o,c=document.createDocumentFragment(),s=document.createDocumentFragment();
l(tt.handleList,encodeURIComponent(JSON.stringify({
comment_id:Z,
offset:dt,
url:location.href
...
S&&m(S)),0==dt?(rt=e.logo_url,_t=e.nick_name,t&&(yt=[]),n=e.elected_comment,n&&n.length?(w(n,c,"elected"),
...
o=e.friend_comment,w(o,s,"friend"),o&&0==o.length&&i(S),t&&(ft.fdlist.innerHTML=""),
ft.fdlist.appendChild(s),o&&o.length?(m(ft.fdmain),(0==window.can_fans_comment_only||1==window.can_fans_comment_only&&1==e.is_fans)&&(i(document.getElementById("js_cmt_addbtn1")),
...
i(document.getElementById("js_cmt_statement")),i(document.getElementById("js_cmt_qa"))):dt+at>=e.elected_comment_total_cnt?(dt=-1,
...
function g(){
st.log("tag1");
var e=d(ft.input.value);
if(st.log("tag2"),!H.hasClass(ft.submit,"btn_disabled")){
if(st.log("tag3"),e.length<1)return b("Comment cannot be blank");
if(st.log("tag4"),e.length>600)return b("600 characters max");
st.log("tag5"),H.addClass(ft.submit,"btn_disabled"),st.log("tag6");
var t=document.getElementById("activity-name");
st.log("tag7"),jt!=e&&(kt=+new Date);
var n=function(t){
{
var n=document.createDocumentFragment();
document.createDocumentFragment();
}
s(),console.log("------------------------",window.friend_comment_enabled),w([{
content:e,
nick_name:_t,
...
default:
jt=e,b("System error. Try again later.");
}
0!=m.ret&&l(tt.addCommentErr,"type:resperr;url:"+encodeURIComponent(o)+";ret="+m.ret);
},
error:function(e){
st.log("shit;"+e.status+";"+e.statusText),l(tt.addCommentErr,"type:ajaxerr;url:"+encodeURIComponent(o));
},
complete:function(){
...
}else pt=0,l(tt.errComment,"type:resperr;url:"+encodeURIComponent(e)+";ret="+m);
},
error:function(){
pt=0,l(tt.errComment,"type:ajaxerr;url:"+encodeURIComponent(e));
},
complete:function(){
i(t),c();
}
...
function w(e,t,n){
var o,m="",i=document.createElement("div"),c="http://mmbiz.qpic.cn/mmbiz/ByCS3p9sHiak6fjSeA7cianwo25C0CIt5ib8nAcZjW7QT1ZEmUo4r5iazzAKhuQibEXOReDGmXzj8rNg/0",s="";
"elected"==n?s=0:"friend"==n&&(s=1),wt={};
for(var d,a=0;d=e[a];++a){
d.time=y(d.create_time),d.status="",d.logo_url=d.logo_url||c,d.logo_url=-1!=d.logo_url.indexOf("wx.qlogo.cn")?d.logo_url.replace(/\/132$/,"/96"):d.logo_url,
...
d.report_elected=d.is_elected||0,d.report_friend=d.is_from_friend||0,d.scene=s,d.reply.reply_list.length>0&&(d.reply.reply_list[0].time=y(d.reply.reply_list[0].create_time),
...
d.new_appmsg=window.new_appmsg,m+=K.tmpl(q,d);
try{
var r=d.nick_name+d.content,_=!1,p=tt.repeatContentID;
wt[r]&&(_=!0,p=tt.repeatContent),yt.indexOf(d.content_id)>-1&&(_=!0,p=tt.repeatContentID),
yt.push(d.content_id),wt[r]=!0,_&&l(p,encodeURIComponent(JSON.stringify({
comment_id:Z,
...
function v(e){
nt=r(),i(ft.article),m(ft.mine),window.__second_open__&&F.os.ios&&m(ft.fakebar),
window.scrollTo(0,0),f(),e||st.later(function(){
ft.input.focus();
});
}
function I(){
...
for(var o=parseInt(n.dataset.status),m=0==o?1:0,i=n.dataset.contentId,c=n.dataset.scene,s=document.querySelectorAll('.js_comment_praise[data-content-id="'+i+'"]'),d=0;d<s.length;d++)C(s[d]);
...
function B(e){
for(var t=e.delegatedTarget,n=parseInt(t.dataset.status),o=n?0:1,m=t.dataset.contentId,i=t.dataset.replyId,c=t.dataset.scene,s=document.querySelectorAll('.js_reply_praise[data-content-id="'+m+'"]'),d=0;d<s.length;d++)C(s[d]);
...
function x(e){
e&&e.preventDefault(),I(),i(ft.fakebar);
}
function M(){
try{
...
})),t)return!!R&&console.log("FakeHash on comment"),void v();
e.preventDefault(),window.__second_open__&&F.os.ios?v():(!!R&&console.log("push comment"),
V.push("comment"));
}
}
...
S&&(S.style.display="none"),Z=0,window._has_comment=!1),0==Z)return void(window._has_comment=!1);
...
var it,ct=e("appmsg/emotion/emotion.js"),st=e("appmsg/emotion/dom.js"),dt=(new Image,
0),at=100,lt=!1,rt="",_t="我",pt=0,ut=!1,gt=["“”","‘’","（）","《》","〈〉","「」","『』","〔〕","【】","［］","[]","｛｝","{}","()","<>"],ft={
...
},yt=[],wt={},ht=(new Image,[]),bt=0,jt=null,kt=+new Date;
...
"none"!==ft.fakebar.style.display&&(clearTimeout(vt),vt=setTimeout(function(){
window.innerWidth!==parseFloat(getComputedStyle(ft.fakebar).width)&&(clearTimeout(It),
...
$.on(window,"scroll",p),$.on(window,"scroll",M),$.on(document.getElementById("js_cmt_write1"),"click",function(e){
L(e);
...
e&&r()<P.getOffset(ft.cmtContainer).offsetTop-Q.getInnerHeight()&&p(!0);
});
});function _typeof(e){
