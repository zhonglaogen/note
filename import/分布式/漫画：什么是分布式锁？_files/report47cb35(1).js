...
ORIGINAL_VIDEO_AD_GRAY_RATE:10,
...
var n=e.data;
s=[];
for(var a in n)n.hasOwnProperty(a)&&s.push(a+"="+encodeURIComponent(n[a]));
s=s.join("&");
}else s="string"==typeof e.data?e.data:null;
console.log("before request");
var p=1,m=function(e,s){
...
try{
a="json"==e.dataType?JSON.parse(n.data):n.data;
}catch(c){
...
l.base_resp&&"-3"==l.base_resp.ret&&p>0&&(i.isIOS||i.isAndroid&&window.clientversion>27000600)?(p--,
r.invoke("updatePageAuth",{},function(t){
console.log("updatePageAuth",t),(new Image).src="https://mp.weixin.qq.com/mp/jsmonitor?idkey=112287_3_1",
t&&t.err_msg&&t.err_msg.indexOf(":ok")>-1?(window.top.pass_ticket=encodeURIComponent(o.getQuery("pass_ticket",t.fullUrl).html(!1).replace(/\s/g,"+")),
e.pass_ticket&&(e.pass_ticket=window.top.pass_ticket),m(e,s),(new Image).src="https://mp.weixin.qq.com/mp/jsmonitor?idkey=112287_4_1"):e.success&&e.success(a);
...
var d="request: "+JSON.stringify(e.type)+" "+JSON.stringify(e.url)+" ;;;; cookie: "+JSON.stringify(document.cookie)+" ;;;; data: "+JSON.stringify(s)+" ;;;; resp: "+JSON.stringify(n);
(new Image).src="https://badjs.weixinbridge.com/badjs?id=226&level=4&msg="+encodeURIComponent(d)+"&uin="+encodeURIComponent(window.uin)+"&from="+encodeURIComponent(window.location.href);
}
...
var o=e("biz_common/utils/url/parse.js"),r=e("biz_wap/jsapi/core.js"),i=e("biz_wap/utils/mmversion.js");
return s;
